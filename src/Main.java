...
public class Main {
    ...
    private static int[] getMove(String player) {
        ...
        int rowMove = SafeInput.getRangedInt(in, "Player " + player + " what row do you want to play in? ", 1, 3);
        int colMove = SafeInput.getRangedInt(in, "Player " + player + " what column do you want to play in? ", 1, 3);
